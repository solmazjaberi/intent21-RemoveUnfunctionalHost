	...
	implements  Serializable
{
	...
	private  COORDINATOR (  )
	{
		...
		ACTIONS.put( "CONFIRMFUNCTIONALITY", generatedbyassl.as.aes.coordinator.actions.CONFIRMFUNCTIONALITY.getInstance() );
		ACTIONS.put( "CHECKHOSTTOOLSTATUS", generatedbyassl.as.aes.coordinator.actions.CHECKHOSTTOOLSTATUS.getInstance() );
		ACTIONS.put( "RECONFIGURE", generatedbyassl.as.aes.coordinator.actions.RECONFIGURE.getInstance() );
		EVENTS.put( "UNFUNCTIONALITY", generatedbyassl.as.aes.coordinator.events.UNFUNCTIONALITY.getInstance() );
		EVENTS.put( "DEVICECHECKED", generatedbyassl.as.aes.coordinator.events.DEVICECHECKED.getInstance() );
		EVENTS.put( "TIMETORECEIVEFUNCTIONALITYMSG", generatedbyassl.as.aes.coordinator.events.TIMETORECEIVEFUNCTIONALITYMSG.getInstance() );
		EVENTS.put( "MSGFUNCTIONALITYRECEIVED", generatedbyassl.as.aes.coordinator.events.MSGFUNCTIONALITYRECEIVED.getInstance() );
		EVENTS.put( "MSGTOOLINACTIVERECEIVED", generatedbyassl.as.aes.coordinator.events.MSGTOOLINACTIVERECEIVED.getInstance() );
		EVENTS.put( "TOOLOK", generatedbyassl.as.aes.coordinator.events.TOOLOK.getInstance() );
		EVENTS.put( "TOOLNOTFOUND", generatedbyassl.as.aes.coordinator.events.TOOLNOTFOUND.getInstance() );
		EVENTS.put( "RECONFIGURATIONDONE", generatedbyassl.as.aes.coordinator.events.RECONFIGURATIONDONE.getInstance() );
		EVENTS.put( "RECONFIGURATIONFAILED", generatedbyassl.as.aes.coordinator.events.RECONFIGURATIONFAILED.getInstance() );
		METRICS.put( "NETWORKMETRIC", generatedbyassl.as.aes.coordinator.metrics.NETWORKMETRIC.getInstance() );
	}
