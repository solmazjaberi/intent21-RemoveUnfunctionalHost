	...
	implements  Serializable
{
	...
	{
		vInitiatedByEvents.add( generatedbyassl.as.aes.coordinator.events.UNFUNCTIONALITY.getInstance() );
		generatedbyassl.as.aes.coordinator.events.UNFUNCTIONALITY.getInstance().addEventCatcher(this); //**** fluent registers for that event
