package generatedbyassl.as.aes.host;
	...
	implements  Serializable
{
	...
	private  AEIP (  )
	{
		MESSAGES.put( "TOOLINACTIVEMSG", generatedbyassl.as.aes.host.aeip.messages.TOOLINACTIVEMSG.getInstance() );
		MESSAGES.put( "FUNCTIONALITYMSG", generatedbyassl.as.aes.host.aeip.messages.FUNCTIONALITYMSG.getInstance() );
		CHANNELS.put( "PRIVATE_LINK", generatedbyassl.as.aes.host.aeip.channels.PRIVATE_LINK.getInstance() );
		FUNCTIONS.put( "SENDTOOLINACTIVEMSG", generatedbyassl.as.aes.host.aeip.functions.SENDTOOLINACTIVEMSG.getInstance() );
		FUNCTIONS.put( "SENDFUNCTIONALITYMSG", generatedbyassl.as.aes.host.aeip.functions.SENDFUNCTIONALITYMSG.getInstance() );
		MANAGED_ELEMENTS.put( "HOST", generatedbyassl.as.aes.host.aeip.managed_elements.HOST.getInstance() );
	}
