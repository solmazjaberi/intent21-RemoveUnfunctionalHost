	...
	implements  Serializable
{
	...
	{
		vFluents.put( "INCRASHINGDEVICE", generatedbyassl.as.autonomicnetwork.asself_management.self_healing.INCRASHINGDEVICE.getInstance() );
	}
	...
	{
		//************************ MAPPING ***********************
		if ( generatedbyassl.as.autonomicnetwork.asself_management.self_healing.INCRASHINGDEVICE.getInstance().isFluentInitiated() ) 
		{
			...
			if ( !isMappingRunning( "INCRASHINGDEVICE" ) ) 
			{
				Thread runActions = new Thread(thrdgrMappings, actionsRunner, "INCRASHINGDEVICE");
				runActions.start();
			}
		}
	}
